...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Bản báo cáo  
...
<form class="form-inline" role="form" id="searchform">
  ...
  <div class="form-group">
    ...
    <select  class="form-control" id="branch" name="branch" >
		<option value="" >Tìm kiếm lớp học</option>
                                    <?php
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Tên/Liên hệ</th><th>Học phí</th><th>Học phí còn lại</th><th>Lớp Học</th><th>DOJ</th><th>Hoạt động</th></tr></thead><tbody></tbody></table>');
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Báo cáo học phí</h4>
        </div>
