...
{
$errormsg = "<div class='alert alert-success'><strong>Thành công!</strong> Thêm Lớp học thành công</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><strong>Thành công!</strong> Sửa Lớp học thành công</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><strong>Thành công!</strong> Xóa Lớp học thành công</div>";
}
...
<head>
    ...
    <title>Hệ thống thanh toán học phí trực tuyến</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Lớp học  
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="branch.php" class="btn btn-primary btn-sm pull-right">Back <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="branch.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Thêm </a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Thêm lớp học": "Sửa lớp học"; ?>
                        </div>
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Thông tin GV </label>
								<div class="col-sm-10">
