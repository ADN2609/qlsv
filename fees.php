...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Thành công!</strong> Nộp học phí thành công</div>";
}
...
<head>
    ...
    <title>Học phí lớp học DADC</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Học Phí  
...
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="email"> Thời gian tham gia </label>
  ...
  <div class="form-group">
   ...
   <button type="button" class="btn btn-success btn-sm" id="find" > Tìm kiếm </button>
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Tên/Liên hệ</th><th>Fees</th><th>Học phí còn lại</th><th>Lớp học</th><th>NAM</th><th>Hoạt động</th></tr></thead><tbody></tbody></table>');
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Mất phí</h4>
        </div>
